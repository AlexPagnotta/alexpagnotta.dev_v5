import { ContentCard, ContentCardBody, ContentCardSubtitle, ContentCardTitle } from "~/features/content/card/card";
...
export const HackAPlantWritingCard = ({ cardProps: { className, ...rest } }: ContentCardProps) => {
  return (
    <ContentCard className={cn("@container", className)} {...rest}>
      ...
      <ContentCardBody>{contentMetadata.description}</ContentCardBody>
    </ContentCard>
  );
};
