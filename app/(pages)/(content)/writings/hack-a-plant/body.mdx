...
<MarkdownImage
  ...
  wide
  className="border border-theme-foreground/10 rounded-md"
  rounded={false}
  showCaption
/>
...
<MarkdownImage alt="Plant Detail View" src={ItemDetailImage} wide className="rounded-md" rounded={false} showCaption />
...
<MarkdownVideo
  ...
  className="aspect-[1534/1080] rounded-md border border-theme-foreground/10"
  wide
  showCaption
  autoPlay
  muted
