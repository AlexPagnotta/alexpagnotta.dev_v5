...
export const MeFaceIcon = () => {
  return (
    <IconTextAligner className="w-24">
      <IconTextAligner.Image src={MeImage} alt="Me" sizes="24px" draggable={false} className="rotate-[8deg]" />
    </IconTextAligner>
  );
};
...
export const MilchickFaceIcon = () => {
  return (
    <IconTextAligner className="w-24">
      <IconTextAligner.Image src={MilchickImage} alt="Milchick" sizes="24px" draggable={false} />
    </IconTextAligner>
  );
};
